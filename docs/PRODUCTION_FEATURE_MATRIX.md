...
| **Zero-Config AI Router** | `PASS` | `echo.music.iad1tya.notune.ai.AiEngine` | Ktor Client / Local Rules | None | DataStore | Optional (Gemini/Groq) | Context Privacy Filter | Unit Tests | `NOT VERIFIED` | Cloud providers require API key if local basic fallback bypassed |
